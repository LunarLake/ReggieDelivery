...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES ('1766200000000000001', '管理员', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '13812312312', '1', '110101199001010047', '1', '2021-05-06 17:20:07', '2021-05-10 02:24:09', '1766200000000000001', '1766200000000000001');
...
-- ----------------------------
-- Migration: 将管理员 id 从 1 更新为 Snowflake 风格 ID，并级联修正所有引用
-- 如果你的数据库已存在旧数据（admin id=1），请单独执行以下 SQL：
-- ----------------------------
-- UPDATE `category`    SET `create_user` = 1766200000000000001, `update_user` = 1766200000000000001 WHERE `create_user` = 1;
-- UPDATE `dish`        SET `create_user` = 1766200000000000001, `update_user` = 1766200000000000001 WHERE `create_user` = 1;
-- UPDATE `dish_flavor` SET `create_user` = 1766200000000000001, `update_user` = 1766200000000000001 WHERE `create_user` = 1;
